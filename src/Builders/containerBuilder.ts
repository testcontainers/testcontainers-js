...
export default abstract class ContainerBuilder<
  ...
  TBuilder extends ContainerBuilder<TContainer, TBuilder>
> {
  protected fn!: ((a?: TContainer) => TContainer);

  constructor(private containerType: new () => TContainer) {}

  public Begin(): ContainerBuilder<
    TContainer,
    ContainerBuilder<TContainer, TBuilder>
  > {
  ...
  ): ContainerBuilder<TContainer, ContainerBuilder<TContainer, TBuilder>> {
  ...
  public WithPortBindings(portBindings: {
    [key: number]: number;
  }): ContainerBuilder<TContainer, ContainerBuilder<TContainer, TBuilder>> {
    this.fn = FnUtils.Compose(this.fn, container => {
